...
- **实测（容器 v2033 工件，A2=0.76 定稿部署；qa 独立验收为准）**：
  - **M6 TIGHTEN wrong 合计 13 ≤17 ✓**（42:1/7:4/123:2/2024:2/777:4；② 16、③-A 18）
  - **EASE wrong 0 ✓**（② 8 步：42:2/123:3/2024:1/777:2/7:0 → 全 seed 0）
  - **EASE correct 16 ≥15 ✓（防伪线）**（0.78 时 13<15 触发防伪线，0.76 达标）
  - **silence 4/5 seed >0.50**：42:0.531/7:0.551/123:0.633/2024:0.490/777:0.510
    → median 0.531 >0.50（**qa 硬线 ≤2/5 超 FAIL**；credit 未回 eligible 池）
  - **merged p̂ 0.4894 < 0.55（partial 未达）** / CI 0.4063 / N 134.25；pool 仅 sentiment+lp
    （credit 出池）
