...
0 10 * * * NTFY_TOPIC=macro-tsx-9005 python3 /vol2/1000/software/macro-scan/核心代码/check_doc_drift.py >> /vol2/1000/software/macro-scan/logs/doc_drift.log 2>&1
```

验证：
```bash
NTFY_TOPIC=macro-tsx-9005 python3 /vol2/1000/software/macro-scan/核心代码/check_doc_drift.py
```
