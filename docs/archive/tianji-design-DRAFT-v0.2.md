...
> **⚠️ 已废弃，仅存史**（DRAFT v0.2，2026-07-24 初稿 / 2026-08-03 arch_review 更新）
> 本文为 DRAFT 阶段的历史设计稿，其中"独立 verification.db / accuracy_dashboard / verify_result.json / scheduler cron 每月1日"等描述与现役实现不符。
> **现役实现请读：[`tianji-design.md`](../tianji-design.md)（v1.0）**。本文保留仅作演进记录，不再更新。
