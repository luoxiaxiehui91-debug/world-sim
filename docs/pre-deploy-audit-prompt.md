...
- **credentials 暴露**：macro-scan/AGENTS.md 里明文写了 `FRED_API_KEY=a3f1dc8fca52b0a45e320ea0383bbac7`——虽然 FRED key 是公共低风险的，但其他配置文件（optim_config.py, docker-compose.yml）是否有更敏感的 key 明文存在？这些文件是否在 .gitignore 中？
