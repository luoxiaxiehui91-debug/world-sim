...
11. **worldsim-pg 统一采集库后续（08-12 晚主线，顺序锁定）**：A0/A0.5/C1/C/A1-min/B1/C0/B0 已完成 ✅（见「当前状态」worldsim-pg 段）。**下一步 D0**：迁 chroma 向量（4156 emb，pgvector `vector(1536)` + ivfflat）→ E0 应用整合。
